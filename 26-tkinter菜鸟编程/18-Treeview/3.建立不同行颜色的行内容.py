...
tree.insert("",index=END,text='随州',values=t2,tags=('evenColor'))
tree.insert("",index=END,text='扬州',values=t3)
tree.insert("",index=END,text='湖州',values=t4,tags=('evenColor'))
tree.insert("",index=END,text='南京',values=t5)
tree.insert("",index=END,text='北京',values=t6,tags=('evenColor'))
