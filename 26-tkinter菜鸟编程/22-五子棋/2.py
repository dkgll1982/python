...
# 修改图标
root.iconbitmap(r'images/spoon.ico')
# 设置窗口标题
root.title('五子棋')
# 创建并添加Canvas
...
cv.pack()
bm = PhotoImage(file=r"images/border.png")
cv.create_image(BOARD_HEIGHT/2 + 1, BOARD_HEIGHT/2 + 1, image=bm)
selectedbm = PhotoImage(file=r"images/select.png")
# 创建选中框图片，但该图片默认不在棋盘中
...
black = PhotoImage(file=r"images/black.png")
white = PhotoImage(file=r"images/white.png")
