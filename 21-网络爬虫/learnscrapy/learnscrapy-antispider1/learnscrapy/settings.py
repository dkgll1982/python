...
# 相当于option.add_argument("--headless")的用法
# selenium处理:您的连接不是私密连接的网站(https ssl 证书)
# 当前我们遇到这样的问题，就要通过代码的层面去解决，参考链接：https://www.cnblogs.com/daiss314/p/14206285.html# requests的话verify参数设置为False
# selenium的话添加参数:--ignore-certificate-errors 
SELENIUM_DRIVER_ARGUMENTS = ['--allow-insecure-localhost',
