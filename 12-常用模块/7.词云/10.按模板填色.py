...
with open(realpath('lagou-job1000-ai-details.txt'),'r',encoding='utf-8') as f:
    text = f.read()

mk = imageio.imread(realpath("img\muban3.png"))
...
# 将词云图片导出到当前文件夹
wc_color.to_file(realpath('img\output10-alice.png'))