#参考链接：https://blog.csdn.net/rozol/article/details/72793304
#!/usr/bin/env python
# coding=utf-8
import os
...
def config_func():
    ...
    config.read(path, encoding="utf-8-sig")  # windows下用记事本保存utf8格式要用utf-8-sig编码集
    # read_file(f, source=None)  # 从f读取和解析配置数据, source:文件名
    config.read_file(open(path, encoding="utf-8-sig"))
