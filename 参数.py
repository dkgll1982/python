...
# 接下来在调用该函数时，既可使用传统的根据位置参数来调用（如上面程序中第 25 行代码所示），
# 也可根据关键字参数来调用（如上面程序中第 27 行代码所示），在使用关键字参数调用时可交换参数的位置（如上面程序中第 29 行代码所示〕，
# 还可混合使用位置参数和关键字参数（如上面程序中第 31 行代码所示）。
